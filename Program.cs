...
namespace PeopleApp
{
    class PeopleApp
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    string s = "IGME-" + i;
            //    Console.WriteLine(courses[s].courseCode);
            //}
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach(string courseCode in student.courseCode)
                                {
                                    try
                                    {
                                        Course target = courses[courseCode];
                                        Console.Write("\t" + target.courseCode + " - ");
                                        Console.Write(target.description + " ");
                                        foreach (DayOfWeek d in target.schedule.daysOfWeek)
                                        {
                                            Console.Write(d + " ");
                                        }
                                        Console.Write($"{target.schedule.startTime:hh:mmtt} - ");
                                        Console.WriteLine($"{target.schedule.endTime:hh:mmtt}");
                                    }
                                    catch
                                    {
                                        break;
                            ...
                            if (thisPerson.GetType() == typeof(Teacher))
                            {
                                ...
                                //try
                                //{
                                //    Course target = courses[teacher.courseCode];
                                //    Console.Write("\t" + target.courseCode + " - ");
                                //    Console.Write(target.description + " ");
                                //    foreach (DayOfWeek d in target.schedule.daysOfWeek)
                                //    {
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                //------------------------------
                string localInputOnly = "";
                do
                {
                    Console.WriteLine("Please enter a Course Code (ex IGME-200) or press enter to continue");
                    localInputOnly = Console.ReadLine();
                    thisStudent.courseCode.Add(localInputOnly);
                
                } while (!(localInputOnly.Length == 0));
                //------------------------------
            }
            ...
            if (thisPerson.GetType() == typeof(Teacher))
            {
                ...
                //Console.WriteLine("Please enter a Course Code (ex IGME-200) or press enter to continue");
                //localInputOnly = Console.ReadLine();
                //thisTeacher.courseCode = localInputOnly;
                //------------------------------
            }
        }
